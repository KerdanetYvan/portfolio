    ...
    <div className="bg-stone-700 min-h-screen text-white p-0 m-0">
      ...
      <main className='p-4 md:p-10 lg:p-20'>
        <section className='container mx-auto flex flex-col md:flex-row gap-4 md:gap-10 items-center justify-center bg-stone-600 rounded-lg p-4 md:p-10 shadow-md'>
          ...
          <div className='md:flex md:flex-col md:gap-2'>
            ...
            <p className='text-center text-xs md:text-base md:text-start'>
              Bachelor Concepteur Développeur de solution digital à{' '}
        ...
        <div className='container mx-auto md:grid md:grid-cols-[2fr_1fr] md:gap-10 mt-10'>
          ...
          <section className='container mx-auto flex flex-col items-start justify-start bg-stone-600 rounded-lg p-4 md:p-10 shadow-md'>
            ...
            <div className='flex items-end gap-1'><p>Français</p></div>
            ...
            <div className='flex items-end gap-1'><p>Espagnol</p></div>
            <div className='grid grid-cols-3 items-center gap-1 p-2 pb-4 md:px-4 w-full'>
      ...
      <section className='p-8 md:p-16'>
        ...
        <div className="flex justify-center gap-6">
          <a href="mailto:kerdanety@gmail.com" className="text-pink-300"><RiMailFill size={32} /></a>
          <a href="https://github.com/KerdanetYvan" target="_blank" rel="noopener noreferrer" className="text-green-400"><RiGithubFill size={32} /></a>
          <a href="https://linkedin.com/in/yvankerdanet" target="_blank" rel="noopener noreferrer" className="text-sky-500"><RiLinkedinFill size={32} /></a>
        </div>
      </section>
    </div>
  );
