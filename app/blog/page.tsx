...
const articlesData: Article[] = Array.isArray(articles) ? (articles as Article[]) : [];
  ...
  return (
    <div className='min-h-screen bg-stone-700'>
      ...
      {articlesData.length !== 0 ? (
        ...
        <p className="text-center text-stone-500 text-2xl font-bold py-16">Aucun article disponible pour l'instant</p>
      )}
    </div>
  );
}
